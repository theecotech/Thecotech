...
import { X, Download, Mail, Phone, MapPin, Calendar, Award, Briefcase, GraduationCap, Code, Users, Zap } from 'lucide-react';
        ...
        <div className="p-8">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <p className="text-gray-600 text-sm">Shopify, WooCommerce, Custom Platforms</p>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <p className="text-gray-600 text-sm">Social Media, SEO, Content Strategy</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-blue-600 pl-6">
                ...
                <p className="text-blue-600 font-medium">Shopify Development • 2024</p>
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 text-xs rounded-full">Shopify</span>
              ...
              <div className="border-l-4 border-blue-600 pl-6">
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  ...
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 text-xs rounded-full">Natural Language Processing</span>
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 text-xs rounded-full">API Integration</span>
                </div>
              </div>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-3">Backend & Database</h3>
                <div className="flex flex-wrap gap-2">
